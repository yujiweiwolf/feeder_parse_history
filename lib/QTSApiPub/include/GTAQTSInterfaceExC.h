...
/// @copyright  Copyright (C), 2008-2020, CSMAR Information Tech. Co., Ltd.
/// @version    3.14
/// @date       2021.10.28
//////////////////////////////////////////////////////////////////////////////
...
/// 获取当前数据的消息类型
/// @return MsgType  --  具体的数据类型
MsgType GTA_API_EXPORT _CDECL GetField_MsgType(void* pQuotationData);
...
/// 获取queue队列数值,数值类型为double
/// @param   pIFieldValue       -- IFieldValue指针，通过此指针获取内部数值
/// @param  Queue          -- 队列地址
/// @param  nSize           -- 队列能存放的数据个数
/// @return true -- 正确返回数据， false -- 数据类型错误，或字符串大小错误
bool GTA_API_EXPORT _CDECL Field_QueueDouble(void* pIFieldValue, double* Queue, unsigned int* size);
