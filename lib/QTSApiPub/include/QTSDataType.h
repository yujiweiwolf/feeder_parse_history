...
/// @file       QTSDataType.h
/// @brief      QTS数据格式定义
/// @copyright  Copyright (C), 2008-2021, CSMAR Information Tech. Co., Ltd.
/// @version    3.14
/// @date       2021.10.28
//////////////////////////////////////////////////////////////////////////////
...
enum MsgType
{
    ...
    Msg_SSEL1_BondStatic			= 0x00101002,       ///< 上交所L1债券静态数据
	Msg_SSEL1_BondQuotation			= 0x00101003,       ///< 上交所L1债券实时行情
	...
	Msg_SSEL2_Order					= 0x00102006,       ///< 上交所L2逐笔委托 UA5801
	Msg_SSEL2_BondStatic			= 0x00102008,		///< 上交所L2债券静态数据
	Msg_SSEL2_BondQuotation			= 0x00102009,		///< 上交所L2债券实时行情 UA3802
	Msg_SSEL2_BondTick				= 0x0010200A,		///< 上交所L2债券逐笔 UA3901
	Msg_SSEL2_BondOverview			= 0x0010200B,		///< 上交所L2债券市场总览 UA3815
    Msg_SSEIOL1_Static				= 0x00103000,       ///< 上交所个股期权静态数据
    Msg_SSEIOL1_Quotation			= 0x00103001,       ///< 上交所个股期权实时行情 UA9002
    Msg_SSEIOL1_Strategy			= 0x0010300F,       ///< 上交所个股期权组合策略
    Msg_SZSEL1_Static				= 0x00201000,       ///< 深交所L1静态数据
    Msg_SZSEL1_Quotation			= 0x00201001,       ///< 深交所L1实时行情
    Msg_SZSEL1_Bulletin				= 0x0020100C,       ///< 深交所L1公告
	Msg_SZSEL1_BondStatic			= 0x00201030,       ///< 深交所L1债券静态数据
	Msg_SZSEL1_BondQuotation		= 0x00201031,       ///< 深交所L1债券实时行情
	...
	Msg_SZSEL2_Tick					= 0x00202004,       ///< 深交所L2逐比消息(对外)
	Msg_SZSEL2_Tick00				= 0x00202020,       ///< 深交所L2逐比消息00
	Msg_SZSEL2_Tick01				= 0x00202021,       ///< 深交所L2逐比消息01
	Msg_SZSEL2_Tick02				= 0x00202022,       ///< 深交所L2逐比消息02
	Msg_SZSEL2_Tick03				= 0x00202023,       ///< 深交所L2逐比消息03
	Msg_SZSEL2_Tick04				= 0x00202024,       ///< 深交所L2逐比消息04
	Msg_SZSEL2_Tick05				= 0x00202025,       ///< 深交所L2逐比消息05
    Msg_SZSEL2_Order				= 0x00202006,       ///< 深交所L2逐笔委托 UA201
    Msg_SZSEL2_Status				= 0x00202007,       ///< 深交所L2证券状态 UA102
	Msg_SZSEL2_Cnindex				= 0x0020200D,       ///< 深交所L2国证指数
	Msg_SZSEL2_BondStatic			= 0x00202030,       ///< 深交所L2债券静态数据
	Msg_SZSEL2_BondQuotation		= 0x00202031,       ///< 深交所L2债券实时行情
	Msg_SZSEL2_BondTransaction		= 0x00202032,       ///< 深交所L2债券逐笔成交
	Msg_SZSEL2_BondOrder			= 0x00202036,       ///< 深交所L2债券逐笔委托
	Msg_SZSEL2_BondTick				= 0x00202034,       ///< 深交所L2债券逐比消息
	Msg_SZSEL2_BondMbrInfo			= 0x00202035,       ///< 深交所L2债券交易商信息
	Msg_SZSEL2_BondInvestorInfo		= 0x00202037,       ///< 深交所L2债券交易主体信息
	Msg_SZSEL2_BondTraderInfo		= 0x00202038,       ///< 深交所L2债券交易员信息
	Msg_SZSEL2_BondBidBookingInfo	= 0x00202039,       ///< 深交所L2债券市场竞买预约信息
    Msg_SZSEIOL1_Static				= 0x00203000,       ///< 深交所个股期权L1静态数据
    Msg_SZSEIOL1_Quotation			= 0x00203001,       ///< 深交所个股期权L1实时行情
    Msg_SZSEIOL1_Status				= 0x00203007,       ///< 深交所个股期权L1证券状态
    Msg_SZSEIOL1_Strategy			= 0x0020300F,       ///< 深交所个股期权L1组合策略
    Msg_CFFEXL2_Static				= 0x00302000,       ///< 中金所L2静态数据
    Msg_CFFEXL2_Quotation			= 0x00302001,       ///< 中金所L2实时行情
    Msg_SHFEL1_Static				= 0x00401000,       ///< 上期所L1静态数据
    Msg_SHFEL1_Quotation			= 0x00401001,       ///< 上期所L1实时行情
    Msg_SHFEL2_Static				= 0x00402000,       ///< 上期所L2静态数据
    Msg_SHFEL2_Quotation			= 0x00402001,       ///< 上期所L2实时行情
    Msg_CZCEL1_Static				= 0x00501000,       ///< 郑商所静态数据
    Msg_CZCEL1_Quotation			= 0x00501001,       ///< 郑商所实时行情
    Msg_ESUNNY_Index				= 0x00501003,       ///< 易盛指数行情	
	Msg_CZCEL1_ArbiQuotation		= 0x00501008,		///< 郑商所L1套利行情
	Msg_CZCEL1_MktStatus			= 0x00501005,		///< 郑商所L1市场状态
	Msg_CZCEL1_Status				= 0x00501007,		///< 郑商所L1品种状态
	Msg_CZCEL2_ArbiStatic			= 0x00502040,		///< 郑商所L2套利静态数据
	Msg_CZCEL2_Static				= 0x00502000,		///< 郑商所L2静态数据
	Msg_CZCEL2_MktStatus			= 0x00502005,		///< 郑商所L2市场状态
	Msg_CZCEL2_Status				= 0x00502007,		///< 郑商所L2品种状态
	Msg_CZCEL2_Quotation			= 0x00502001,		///< 郑商所L2实时行情(不常变部分)
	Msg_CZCEL2_ChgQuotation			= 0x00502041,		///< 郑商所L2实时行情(常变部分)
	Msg_CZCEL2_LevelQuotation		= 0x0050200C,		///< 郑商所L2五档深度委托行情
	Msg_CZCEL2_MarchPriceQty		= 0x0050200B,		///< 郑商所L2分价成交量行情
    Msg_DCEL1_Static				= 0x00601000,       ///< 大商所L1静态数据
    Msg_DCEL1_Quotation				= 0x00601001,       ///< 大商所L1最优行情
	Msg_DCEL1_OptionParameter		= 0x00601004,       ///< 大商所L1期权参数
	Msg_DCEL1_MktStatus				= 0x00601005,       ///< 大商所L1市场状态
	Msg_DCEL1_Status				= 0x00601007,       ///< 大商所L1交易状态
    Msg_DCEL1_ArbiQuotation			= 0x00601008,       ///< 大商所L1套利行情
    Msg_DCEL2_Static				= 0x00602000,       ///< 大商所L2静态数据
    Msg_DCEL2_Quotation				= 0x00602001,       ///< 大商所L2最优深度行情
    Msg_DCEL2_OptionParameter		= 0x00602004,       ///< 大商所L2期权参数
    Msg_DCEL2_MktStatus				= 0x00602005,       ///< 大商所L2市场状态
    Msg_DCEL2_Status				= 0x00602007,       ///< 大商所L2交易状态
    ...
    Msg_DCEL2_LevelQuotation		= 0x0060200C,       ///< 大商所L2五档深度行情
    Msg_DCEL2_OrderQueue			= 0x0060200F,       ///< 大商所L2委托队列行情
    ...
    Msg_HKEXL2_DQB					= 0x00702011,       ///< 港交所L2互联市场日余额
    Msg_HKEXL2_MoneyFlow			= 0x00702012,       ///< 港交所L2资金流向
    Msg_HKSHL1_Static				= 0x00703000,       ///< 沪港通L1静态数据
    Msg_HKSHL1_Quotation			= 0x00703001,       ///< 沪港通L1实时行情
    Msg_HKSHL1_Overview				= 0x00703005,       ///< 沪港通L1市场总览
    Msg_HKSZL1_Static				= 0x00704000,       ///< 深港通L1静态数据
    Msg_HKSZL1_Quotation			= 0x00704001,       ///< 深港通L1实时行情
    Msg_HKSZL1_Overview				= 0x00704005,       ///< 深港通L1市场总览
    Msg_INEL1_Static				= 0x00801000,       ///< 上期能源L1静态数据
    Msg_INEL1_Quotation				= 0x00801001,       ///< 上期能源L1实时行情
    Msg_INEL2_Static				= 0x00802000,       ///< 上期能源L2静态数据
    Msg_INEL2_Quotation				= 0x00802001,       ///< 上期能源L2实时行情
	Msg_BSEL1_Static				= 0x00901000,       ///< 北交所L1静态数据
	Msg_BSEL1_Quotation				= 0x00901001,       ///< 北交所L1实时行情
};
/// 数据分类，多个市场汇总后的分类
enum DataCategory
{
...
enum RetCode
{
	...
	Ret_NoSubInnerMsg           = 12,   ///< 不能订阅或退订内部通讯消息
};
...
enum FieldID
{
    ...
    FID_CFICode                 = 1043,         ///< 证券类别. "上交所：‘ES'表示股票；‘EU’表示基金；‘D’表示债券；‘RWS’表示权证；‘FF’表示期货。
    ...
    // 2.8.2 增加Attribute 字段
    FID_Attribute               = 1390,        ///< 股票属性(深交所)
    FID_NoProfit                = 1714,        ///< 是否尚未盈利(深交所)
    FID_WeightedVotingRights    = 1715,        ///< 是否存在投票权差异(深交所)

    FID_GageUnderlying          = 1711,         ///< 担保品标的标志(上交所)
    FID_CrdBuyBalance           = 1712,        ///< 融资余额(上交所)
    FID_CrdSellMargin           = 1713,        ///< 融券余量(上交所)

    // 2.8.5 港交所L2 增加 字段
    FID_ProductType             = 1427,         ///< 证券产品类型
    FID_StrikePrice2            = 1429,         ///< 执行价格2
    FID_WarrantType             = 1536,         ///< 权证类型
    FID_CallPrice               = 1537,         ///< 牛熊证认购价
    FID_DecimalsInCallPrice     = 1538,         ///< 牛熊证认购价小数位
    FID_Entitlement             = 1539,         ///< 权证权益
    FID_DecimalsInEntitlement   = 1540,         ///< 权证权益小数位
    FID_NoWarrantsPerEntitlement= 1716,         ///< 每份权益的权证数量

    //上期所二代增加
    FID_InstrumentNo            = 1801,         ///< 合约编码
    FID_OptionsType             = 1802,         ///< 期权类型
    FID_VolumeMultiple          = 1803,         ///< 合约数量乘数 double 小数位
    FID_UnderlyingMultiple      = 1804,         ///< 合约基础商品乘数
    FID_IsTrading               = 1805,         ///< 标明是否交易
    FID_CodecPrice              = 1806,         ///< 编码基准价 double 小数位
    FID_CenterChangeNo          = 1807,         ///< 数据中心编号
    FID_SnapNo                  = 1808,         ///< 快照行情编号
    FID_PacketNo                = 1809,         ///< 当前增量行情编号
    FID_ChangeNo                = 1810,          ///< 当前合约编号
...
#define COMBINATION_STRATEGY_LEN  8   ///< 深交所个股期权组合策略信息个数  
#define HEART_BEAT_INTERVAL 3         ///< 发送心跳包时间间隔 单位s
...
/// 协议类型
enum ProtocolType{
    Protocol_Type_A   = 0,   ///< 表示TCP协议
    Protocol_Type_B   = 1,   ///< 表示UDP协议
};
