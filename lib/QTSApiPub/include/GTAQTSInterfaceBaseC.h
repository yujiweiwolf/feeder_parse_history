...
/// 郑商所L2套利静态数据订阅数据实时回调接口
/// @param  pRealCZCEL2ArbiStatic -- 实时数据
typedef void (*OnBaseSubscribe_CZCEL2_ArbiStatic)(const CZCEL2_ArbiStatic* pRealCZCEL2ArbiStatic);
void GTA_API_EXPORT _CDECL SetOnBaseSubscribe_CZCEL2_ArbiStatic(OnBaseSubscribe_CZCEL2_ArbiStatic cbOnBaseSubscribe_CZCEL2_ArbiStatic);
...
/// 郑商所L2实时行情(常变部分)订阅数据实时回调接口
/// @param  pRealCZCEL2ChgQuotation -- 实时数据
typedef void (*OnBaseSubscribe_CZCEL2_ChgQuotation)(const CZCEL2_ChgQuotation* pRealCZCEL2ChgQuotation);
void GTA_API_EXPORT _CDECL SetOnBaseSubscribe_CZCEL2_ChgQuotation(OnBaseSubscribe_CZCEL2_ChgQuotation cbOnBaseSubscribe_CZCEL2_ChgQuotation);
...
/// 郑商所L2分价成交量行情订阅数据实时回调接口
/// @param  pRealCZCEL2MarchPriceQty -- 实时数据
typedef void (*OnBaseSubscribe_CZCEL2_MarchPriceQty)(const CZCEL2_MarchPriceQty* pRealCZCEL2MarchPriceQty);
void GTA_API_EXPORT _CDECL SetOnBaseSubscribe_CZCEL2_MarchPriceQty(OnBaseSubscribe_CZCEL2_MarchPriceQty cbOnBaseSubscribe_CZCEL2_MarchPriceQty);
...
/// 查询郑商所L2套利静态数据
/// @param  pCodeList                      -- 快照订阅列表，NULL时为全市场快照数据
/// @param  ppSnapCZCEL2ArbiStatic -- 快照数据列表，需调用BaseReleaseBulletinValue释放内存
/// @param  pSize                -- 返回数据个数
/// @return RetCode              -- 错误代码
RetCode GTA_API_EXPORT _CDECL BaseQuerySnap_CZCEL2_ArbiStatic(char* pCodeList,CZCEL2_ArbiStatic** ppSnapCZCEL2ArbiStatic, int* pSize);
...
/// 查询郑商所L2实时行情(常变部分)
/// @param  pCodeList                      -- 快照订阅列表，NULL时为全市场快照数据
/// @param  ppSnapCZCEL2ChgQuotation -- 快照数据列表，需调用BaseReleaseBulletinValue释放内存
/// @param  pSize                -- 返回数据个数
/// @return RetCode              -- 错误代码
RetCode GTA_API_EXPORT _CDECL BaseQuerySnap_CZCEL2_ChgQuotation(char* pCodeList, CZCEL2_ChgQuotation** ppSnapCZCEL2ChgQuotation, int* pSize);
...
/// 查询郑商所L2分价成交量行情
/// @param  pCodeList                      -- 快照订阅列表，NULL时为全市场快照数据
/// @param  ppSnapCZCEL2MarchPriceQty -- 快照数据列表，需调用BaseReleaseBulletinValue释放内存
/// @param  pSize                -- 返回数据个数
/// @return RetCode              -- 错误代码
RetCode GTA_API_EXPORT _CDECL BaseQuerySnap_CZCEL2_MarchPriceQty(char* pCodeList, CZCEL2_MarchPriceQty** ppSnapCZCEL2MarchPriceQty, int* pSize);
