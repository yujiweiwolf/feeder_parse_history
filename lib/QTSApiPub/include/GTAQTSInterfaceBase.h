...
public:
	...
	/// @param  RealCZCEL2ArbiStatic -- 实时数据
	virtual void OnSubscribe_CZCEL2_ArbiStatic(const CZCEL2_ArbiStatic& RealCZCEL2ArbiStatic){}
	...
	/// @param  RealCZCEL2ChgQuotation -- 实时数据
	virtual void OnSubscribe_CZCEL2_ChgQuotation(const CZCEL2_ChgQuotation& RealCZCEL2ChgQuotation){}
	...
	/// @param  RealCZCEL2MarchPriceQty -- 实时数据
	virtual void OnSubscribe_CZCEL2_MarchPriceQty(const CZCEL2_MarchPriceQty& RealCZCEL2MarchPriceQty){}
};
...
public:
	...
	/// 查询郑商所L2套利静态数据
	/// @param  pCodeList                     -- 快照订阅列表，NULL时为全市场快照数据
	/// @param  SnapCZCEL2ArbiStatic  -- 快照数据列表
	/// @return RetCode                       -- 错误代码
	virtual RetCode QuerySnap_CZCEL2_ArbiStatic(char* pCodeList, CDataBuffer<CZCEL2_ArbiStatic>& SnapCZCEL2ArbiStatic) = 0;
	...
	/// 查询郑商所L2实时行情(常变部分)
	/// @param  pCodeList                     -- 快照订阅列表，NULL时为全市场快照数据
	/// @param  SnapCZCEL2ChgQuotation  -- 快照数据列表
	/// @return RetCode                       -- 错误代码
	virtual RetCode QuerySnap_CZCEL2_ChgQuotation(char* pCodeList, CDataBuffer<CZCEL2_ChgQuotation>& SnapCZCEL2ChgQuotation) = 0;
	...
	/// 查询郑商所L2分价成交量行情
	/// @param  pCodeList                     -- 快照订阅列表，NULL时为全市场快照数据
	/// @param  SnapCZCEL2MarchPriceQty  -- 快照数据列表
	/// @return RetCode                       -- 错误代码
	virtual RetCode QuerySnap_CZCEL2_MarchPriceQty(char* pCodeList, CDataBuffer<CZCEL2_MarchPriceQty>& SnapCZCEL2MarchPriceQty) = 0;
};
